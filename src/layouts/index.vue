...
<style lang="scss">
 .layout-container-vertical {
      .el-menu{
        ...
        .el-menu-item {
           background:none!important;text-align:center!important;line-height:40rem!important; box-sizing: border-box!important;padding-top:35rem!important;
           span {
            display:block;
           }
           .vab-fas-icon {font-size:30rem!important;}
        }
        .is-active {
          background:url(../assets/hovbg.png) no-repeat top right!important;
          background-size:113rem 140rem!important;
        }
      }
 }
</style>
